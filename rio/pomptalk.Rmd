---
title: On the Conversation between Scientist and Data
author: |
  Aaron A. King<br>
...
<!--
Abstract: As scientists, we ask questions of data.
Whether and how the data choose to reply depends on how the question is posed, and we often struggle to pose just the right question.
How can we best ask the questions so that the answers are least clouded by assumptions of convenience or tradition?
How can we tell when the assumptions we must make are getting in the way of what the data want to say? 
In this talk, I will be interested in modeling methods that distort the communication channels as little as possible and in procedures by which we can recognize when the data are trying to tell us that we are asking the wrong
question.
-->
...
- Felicia&nbsp;Magpantay, Matthieu&nbsp;Domenech&nbsp;de&nbsp;Cell&egrave;s, Carles&nbsp;Bret&oacute;, Jennie&nbsp;Lavine, Daihai&nbsp;He
...
Q: *"How will the distribution and prevalence of a given infection change with climate?"*

A: "That depends...."

Q: *"Can we eradicate a given infectious disease using a given vaccine?"*
...
Q: *"How do climate conditions and their fluctuations affect the distribution and prevalence of a given infectious disease?"*

A: "That depends...."

Q: *"Does infection by a given infectious disease confer immunity against reinfection?"*
...
Q: *"Are climatic differences responsible for differences in the epidemiology in different locations?"*

A: "To a degree...."

Q: *"Does the peak of the epidemic occur because of the build-up of herd immunity?"*

A: "To some extent...."

Q: *"Does the peak of the epidemic result from the turn of the season?"*
