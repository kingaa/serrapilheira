...
dN_{Y\emptyset}&=\mu\,Y\,dt+\sigma_{Y\emptyset}(Y)\,dW_2(t)\\
\end{aligned}
$$
...
$$
\begin{aligned}
dX&=B\,dt-dN_{XY}-dN_{Y\emptyset}\\
&=B\,dt-(\lambda+\mu)\,Y\,dt\\
&\qquad-\sigma_{XY}(X)\,dW_1(t)-\sigma_{Y\emptyset}(Y)\,dW_2(t)\\
dY&=dN_{XY}\\
...
**It is extremely useful to know *when you cannot know.***
...
- There is an abiding need for further methodological development of such methods to improve computational efficiency and accommodate new data types.
