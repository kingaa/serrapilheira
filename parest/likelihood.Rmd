...
For your convenience, the **R** codes for this document are `r xfun::embed_file("likelihood.R",text="provided in a script")` which you can download, edit, and run.
...
The method of maximum likelihood was introduced by @Fisher1922.
