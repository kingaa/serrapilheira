...
After `r local_mifs[[1]]@Nmif` IF2 iterations, the log likelihoods appear to have already reached the vicinity of what we found for the SIR model, with small s.e. ([if `logmeanexp` is to be trusted](https://kingaa.github.io/serrapilheira/pfilter/loglikest.html)).
...
[[More about `bake` here.](https://kingaa.github.io/serrapilheira/misc/bake.html)].
