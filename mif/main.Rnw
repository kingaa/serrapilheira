...
\title{Iterated filtering: principles and practice}
...
\begin{frame}[fragile,allowframebreaks=0.8]{Parallel computing}
  ...
  \link{https://kingaa.github.io/serrapilheira/pfilter/}{Lesson 3} discusses how to accomplish this using \pkg{foreach}.
