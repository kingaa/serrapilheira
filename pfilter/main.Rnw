...
\begin{frame}[fragile,allowframebreaks]{Particle filtering in \pkg{pomp}}
  ...
  Here, we repeat the construction of the SIR model \link{https://kingaa.github.io/sbied/stochsim/}{we looked at earlier}, using the parameters chosen by looking at simulations.
...
\begin{frame}{Profile likelihood estimation}
  ...
  We will explain this method below and put it into practice in the \link{https://kingaa.github.io/sbied/mif/}{next lesson}.
\end{frame}
