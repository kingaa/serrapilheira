...
params:
  prefix: pomptalk
nocite: |
  @Lavine2011, @DomenechdeCelles2016, @DomenechdeCelles2018, @King2016
---
...
- Guiding policy
- Making forecasts
- Forestalling unintended consequences
...
...all rely on the models' ability to *explain* the data correctly.
...
Understanding and prediction are two sides of the same coin.
...
1. Models as scientific instruments
